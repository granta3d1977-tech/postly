...
const providers = [
  ...(google.clientId && google.clientSecret ? [Google({ clientId: google.clientId, clientSecret: google.clientSecret })] : []),
  ...(github.clientId && github.clientSecret ? [GitHub({ clientId: github.clientId, clientSecret: github.clientSecret })] : []),
];
